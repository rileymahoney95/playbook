...
function Login({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <main className="login">
      ...
      <p className="muted mt-2">Your routines are ready when you are.</p>
  ...
  if (authenticated === null)
    return (
      <main className="shell">
        <span className="brand">playbook</span>
    ...
    <>
      <header className="app-header">
        <div className="shell header-inner">
          ...
          <button className="text-link text-sm" onClick={logout} disabled={loggingOut}>
            Sign out
          </button>
        </div>
      </header>
